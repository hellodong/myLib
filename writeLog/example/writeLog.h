...
#if defined(WRITE_LOG) && !defined(PRINT_LOG)
#define LOG_FATAL(format, arg...)                WRITELOG_FATAL(format, ##arg)                  
#elif defined(PRINT_LOG) && !defined(WRITE_LOG)
#define LOG_FATAL(format, arg...)                PRINTLOG_FATAL(format, ##arg) 
#elif defined(WRITE_LOG) && defined(PRINT_LOG)
#define LOG_FATAL(format, arg...)                       \
                do{                                     \
                        PRINTLOG_FATAL(format, ##arg);  \
                        WRITELOG_FATAL(format, ##arg);  \
                }while(0)
#else
#define LOG_FATAL(format, arg...)
#endif
...
#define LOG_ERROR(format, arg...)                       \
                do{                                     \
                        PRINTLOG_ERROR(format, ##arg);  \
                        WRITELOG_ERROR(format, ##arg);  \
                }while(0)
#else
#define LOG_ERROR(format, arg...)                
#endif
...
#define LOG_WARN(format, arg...)                        \
                do{                                     \
                        PRINTLOG_WARN(format, ##arg);   \
                        WRITELOG_WARN(format, ##arg);   \
                }while(0)
#else
#define LOG_WARN(format, arg...)                
#endif
...
#define LOG_INFO(format, arg...)                        \
                do{                                     \
                        PRINTLOG_INFO(format, ##arg);   \
                        WRITELOG_INFO(format, ##arg);   \
                }while(0)
#else
#define LOG_INFO(format, arg...)                
#endif
...
#define LOG_TRACE(format, arg...)                       \
                do{                                     \
                        PRINTLOG_TRACE(format, ##arg);  \
                        WRITELOG_TRACE(format, ##arg);  \
                }while(0)
#else
#define LOG_TRACE(format, arg...)                
#endif
...
#define LOG_DEBUG(format, arg...)                       \
                do{                                     \
                        PRINTLOG_DEBUG(format, ##arg);  \
                        WRITELOG_DEBUG(format, ##arg);  \
                }while(0)
#else
#define LOG_DEBUG(format, arg...)                
#endif
